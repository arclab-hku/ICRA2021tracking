...
def arg_parse():
    ...
    parser.add_argument("--yaml", dest="yaml_path", help="Yaml path", default="./config/benchmark_task_info.yaml", type=str)
...
dataset_list = os.listdir(task_info.video_path + 'data_seq/UAV123/')

for dataset in dataset_list:
    img_list = os.listdir(task_info.video_path + 'data_seq/UAV123/' + dataset + '/')
